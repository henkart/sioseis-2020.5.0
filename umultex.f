...
!     UMULTEX IS THE EXECUTION PHASE OF THE SEISMIC REFLECTION PROCESS UMULT
!  (USER GIVEN TRACE MULTIPLY).  THE USER'S PARAMETERS MUST BE IN
!  DISC FILE MUNIT (IN COMMON /UMULT/) AND THE TRACE WITH TRACE HEADER
