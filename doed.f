...
!                                                                            
!                          PROCESS DISKOX, where X = { A, B, C, D }
!                          ------- ------
!
!   
...
!  mod 22 May 1990 - Allow OFMT 4 - UTIG 16 bit floating point
!  mod 19 Feb 91 - add parameter secs and decimf
!  mod 19 Jan 92 - change fno and lno to DEFAULT rather than just preset
!  mod ???? (94?) - Do not create output file unless in procs list!
!  mod 17 May 95 - Add the SU and SEGY format options.
!  29 Jan. 96 - Change lrange preset from 999999 to NONE
!  5 June 96 - Change ftr preset from 1 to 0
!  21 Aug 96 - Add parameter REWIND
!  26 Aug 96 - Add check for lno given when noinc given.
!  17 Mar 97 - Add FLINC
!  20 Jul 97 - Allow negative fno/lno.  Change lno preset to -999999
!  7 June 99 - Add parameter BIG for creating files > 2GB.
!  12 Jul 99 - Allow 10 diskox processes!
!  20 Sep 02 - Change BIG preset from NO to YES (0 to 1)
!  18 Mar 03 - Add parameter TRACE0, write trace 0 
!  1 May 03 - Add parameter EXTHDR whether to write the Rev 1 Extended
!             Textual records.  yes/no
...
!  mod 1 July 08 - Allow big DECIMF (up to 1000)
!  mod 18 Jul 08 - Increase opath and token to 200 characters.
!  mod 17 Jun 09 - Add RENUM and RETRAC
!  mod 12 Jun 12 - RENUM was bad. (ajh spotted)
!  mod 19 Jul 12 - FON stopped working because of 12 Jun 12 change
!  mod 29 Nov 12 - Warn that IBM output may/will not work (gcc47 on Mac fails)
!  mod 30 Jan 13 - Remove that warning because LRSHIFT was changed to zero vacated bits
!
!  *** Programmer notes:
!   idisko is set by the contoller (contro). DISKOA = 1, DISKOB = 2, etc.
!
...
!****
!****    Write the DISKO parameters to a disc file  and get another list!
!****
      lscr(26) = fno
      lscr(27) = lno
      lscr(28) = noinc
      ...
      lscr(31) = trinc
      lscr(32) = fon
!****  renum is the same as FON, and has precedence
