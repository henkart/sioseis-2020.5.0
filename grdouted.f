      SUBROUTINE grdouted
!
!     The edit phase of SIOSEIS process grdout, which writes a GMT
!  grd formated file.
!
!  Written by Paul Henkart, January 2001
!  Copyright (C) 2001 The Regents of the University of California
!  ALL RIGHTS RESERVED.
!
!  mod 18 Jul 03 - Use REAL*8 for gmt variables.
!  mod 13 Jan 04 - Add parameter IPAD
!  mod 22 Jan 08 - Add error when opath not given.
!  mod 24 Jan 08 - Add parameters TYPE, Y_ORDER, Z_ID, NCID, T_INDEX, NAN_VALUE,
!                                 XY_OFF
!
      PARAMETER ( npars = 28 )
