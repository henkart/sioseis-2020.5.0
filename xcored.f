...
!  ALL RIGHTS RESERVED.
!
!  mod 5 Apr 99 - Add parameter CATS
!  mod 8 June 00 - 32 bit integer pilot was wrong (thanks to g77)
!  mod 1 Dec 08 - ppath didn't work on Intel
!
      PARAMETER ( nmulti = 0 )
...
!****
!****  read pilot trace if it's in another file
!****
