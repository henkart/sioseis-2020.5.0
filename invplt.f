...
!     INVPLT INITIALIZES THE VELOCITY SPECTRA PLOT.  IT PRINTS THE HEADER OF
!  THE PLOT AND FILLS THE BACKGROUND OF THE PLOT WITH THE CHARACTER IN ICHAR.
!  IT ALSO PUTS IN THE GRID FOR FOLLOWING THE VELOCITY DOWN THE PAGE.
!
!  ARGUMENTS:
!  VTUPLE - AN ARRAY CONSISTING OF THE START TIME OF THE ANALYSIS, THE END
!           TIME OF THE ANALYSIS, AND THE NUMBER OF PRINTER COLUMNS BETWEEN THE
!           TWO.
!  ISCR   - AN SCRATCH ARRAY AT LEAST 2000 16 BIT WORDS.
!  LBUF   - THE TRACE HEADER ARRAY.
!  ICHAR  - THE A2 FORMATED CHARACTER TO FILL THE BACKGROUND OF THE PLOT WITH.
!
!
!  WRITTEN AND COPYRIGHTED BY:
!  PAUL HENKART, SCRIPPS INSTITUTION OF OCEANOGRAPHY, 20 MAY 1981
...
!
!  mod 10 Mar 94 - grid at end of plot was off 1 column
!  mod 17 Oct 95 - The grid was right, it was pltvs that was off!
!
      INTEGER*2 ISCR,IBUF
      CHARACTER*1 ICHAR
...
1     FORMAT('1')
      PRINT 20
      PRINT 20
!      PRINT 10, (ISCR(I),I=1,12)                                       ! FORM FEED FIRST
      PRINT 20
   ...
   70 FORMAT(8X,I4,10(5X,I5))
      DO I=1,132                                                     ! BUILD THE BACKGROUND AND THE GRID
  ...
  100    MASTER(I:I)='+'                                                   ! THIS IS THE GRID
   ...
   81 FORMAT(A)
      DO I=1,LSIZE                                                  ! NOW FILL THE ENTIRE PLOT WITH THE MASTER
  110    IA(I)=MASTER
      ENDDO
      RETURN
      END
