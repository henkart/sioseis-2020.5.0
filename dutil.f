      PROGRAM DUTIL
!    DUTIL is a disk utility program meant for cracking into any disk
!  file and figuring out what it contains.
!  mod - remove D1
!
      PARAMETER ( nopts = 25 )                                          ! the number of DUTIL options
...
!      INTEGER*8 lltemp
     ...
     *    'DV','DW','PO','PW','QU','S1','S3','S6','CO','WR','OP',
     *    'CU','RK','AD','FZ'/
  ...
  100 CONTINUE
     ...
     &' Enter an option: he, rd, dr, da, de, dz, di, dl, dm, dd, dv,'
      PRINT *,
     &'  dw, po, pw, qu, s1, s3, s6, co, wr, op, cu, rk, ad, fz'
      CALL rdline
