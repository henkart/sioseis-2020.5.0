...
!     Polynomial interpolation.  "Numerical Recipes", page 82 (sect 3.1)
!  Given array XA and YA, each of length N, and given a value X, this 
!  routine returns a value Y, and an error estimate DY.  If P(x) is the
!  polynomial of degree N-1 such that P(XA) = YA, i = 1,...N, then
