...
!**** GMK had to change velocity taustep loop to include tau step at t = 0
!**** GMK thus, no taustp exists at the bottm of the section ( t = insamp)
!**** GMK because of this, averaging loop was modified below 
          sp = 1
          DO 200 tau = 1, ntau
!
...
!**** GMK Since there is not a (tau+1) taustp need to set sc = to last samp
!**** GMK thereby averaging over entire taustep
               if (tau.eq.ntau) then
                 sc = insamp
               endif
!
