...
!          REQUIRED.
!  MARGIN - The length of the top margin.
!          Preset = 0.
!  COLOR - A logical switch (yes or no) indicating whether the plots
!          named in IPATH are color or not.  This is needed only on
!          color plotters (DesignJet 650C, models 2858 and 2859) when
!          plotting a black and white plot.
!  RO    - Rotate Coodrinate System.  Rotates the plotter's coordinate
!          system 90, 180, and 270 degress counterclockwise.
!          Allowable values are: 0, 90, 180, 270
!          Preset = 0.
!  header
!  slpath
