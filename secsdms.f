...
!    convert from geodetic degrees/minutes/seconds to seconds of an arc.
!
! ARGUMENTS:
! iflag   >=0, converts seconds to degrees/minutes/seconds.
!         <0, converts degrees/minutes/seconds to seconds.
! seconds - the REAL number of degrees to convert
! ideg    - The integer number of degrees returned.
! min     - The integer number of minutes returned.
! sec     - The REAL number of seconds returned.
!
