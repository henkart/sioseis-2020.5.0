...
!                                    PROCESS ACORR (AUTOCORRELATION)
!                                    ------- -----
!
!  DOCUMENT DATE: 6 JULY 1981                                              46
!
!       PROCESS ACORR COMPUTES THE ONESIDED AUTOCORRELATION FUNCTION OF A TRACE.
!    ONLY POSITIVE LAGS OF THE AUTOCORRELATION ARE COMPUTED AND OUTPUT.  IF
!  MORE THAN ONE AUTOCORRELATION WINDOW IS SPECIFIED ON EACH TRACE, EACH
!  OUTPUT TRACE IS THE CONCATENATION OF ALL THE AUTOCORRELATIONS FOR THAT TRACE
!  THUS, THE OUTPUT LENGTH IS THE SUM OF THE LENGTHS OF THE INDIVIDUAL WINDOWS.
!     MORE THAN ONE AUTOCORRELATION WINDOW MAY BE GIVEN FOR EACH TRACE,  AND THE
!  WINDOWS MAY BE SPATIALLY VARIED BY SHOT OR RP OR BY HANGING THE WINDOWS ON
!  THE WATER BOTTOM.
...
!  OF ACORR PARAMETERS MUST BE TERMINATED BY THE WORD END.
!
!  THE PARAMETER DICTIONARY
!  --- --------- ----------
!  FNO    - THE FIRST SHOT (OR RP) TO AUTOCORRELATE.  SHOT (RP) NUMBERS
!           MUST INCREASE MONOTONICALLY.
!           PRESET=1
!  LNO    - THE LAST SHOT (RP) NUMBER TO AUTOCORRELATE.  LNO MUST BE
!           LARGER THAN FNO IN EACH LIST AND MUST INCREASE LIST TO LIST.
!           DEFAULT=FNO
!  SETS   - START-END TIME PAIRS DEFINING THE AUTOCORRELATION WINDOWS.  TIMES
!           ARE IN SECONDS AND MAY BE NEGATIVE WHEN HANGING THE WINDOWS FROM THE
!           WATER BOTTOM.  A MAXIMUM OF 5 WINDOWS MAY BE GIVEN.
!           REQUIRED.
!  OLENS  - THE OUTPUT AUTOCORRELATION LENGTHS IN SECONDS.  THIS CORRESPONDS TO
!           THE NORMAL USE OF THE NUMBER OF LAGS TO COMPUTE, BUT IS IN UNITS OF
!           SECONDS.  EACH AUTOCORRELATION HAS IT'S OWN LENGTH.  A MAXIMUM OF
!           5 LENGTHS MAY BE GIVEN.
!           REQUIRED.
