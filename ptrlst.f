      ...
      CHARACTER*120 line
!
!  Written August 2009, replacing ptrlist.c because I couldn't figure out how
!      to make c and fortran to make nice with writing to a file rather than stdout
!
!    mod 17 Sept 09 - g95 doesn't like FLOAT(short)
!    mod 6 Oct 11 - Add fold (type 32)
!    mod 11 Sep 12 - Read decimal degrees correctly
!                  - Receiver X & Y used source
      j = 1
      line = ' '
      DO i = 1, ntrlist
