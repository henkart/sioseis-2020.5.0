...
c     mp32ieee converts MP3 floating point to IEEE floating point.
c
c  ARGUMENTS:
c  inbuf  - The input array of MP3 floats to be converted.
c           This may be IEEE 16 bit floating point
