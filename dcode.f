...
!     DCODE RETURNS A REAL NUMBER GIVEN A STRING OF CHARACTERS.  THIS RESEMBLES
...
!    AREAL - THE FLOATING POINT (REAL) NUMBER DECODED BY DCODE.  THIS VALUE
!            IS RETURNED BY DCODE.   REAL*4
