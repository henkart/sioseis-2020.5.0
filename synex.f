...
!     SSYNEX IS THE EXECUTION PHASE OF THE SEISMIC REFLECTION PROCESS SYN
!  (SYNTHETIC INPUT).  THE USER'S PARAMETERS MUST BE IN
!  DISC FILE MUNIT (IN COMMON /SYN/) AND THE TRACE WITH TRACE HEADER
!  WILL BE LEFT IN MEMORY ARRAY BUF.
!
!  ARGUMENTS:
...
!  ISTOP  - A SIGNAL TO THE CONTROLLER INDICATING THAT THERE IS NO MORE
!           INPUT TO BE GENERATED, AND SYNEX SHOULD NOT BE CALLED AGAIN.
!
!  COPYRIGHTED BY:
