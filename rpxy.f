...
!****  Given the source (x,y) and the range from the segy header,
!****  Remove the setback from the source x,y and rewrite 19 & 20 and
!****  compute the receiver (x,y) and write it in header 21 & 22
!
!  mod 24 Sep 09 - Compute the angle differently
!  mod 15 Mar 13 - make more variables REAL*8, treat first differently
!  mod 20 Mar 13 - Make wbaldwin changes for quadrant.
!
...
!**** Use the existing angle if the same shot as before
          shotno1 = shotno2
          shotno2 = lhdr(3)
          d19 = DFLOAT(lhdr(19))
          d20 = DFLOAT(lhdr(20))
...
!	print *,' 1_m=',x1_m,y1_m,' 2=',x2_m,y2_m,' inverse_angle=',angle
!****
!****   Do the source coordinates
!****
      dtemp = setback
      dx = dtemp * DSIN(angle/rad)
      dy = dtemp * DCOS(angle/rad)
!	 print *,' dx=',dx,' dy=',dy,' dtemp=',dtemp,x2_m,y2_m
      d19 = x2_m + dx
      d20 = y2_m + dy
!	 print *,' d19=',d19,' d20=',d20, ihdr(36)
...
!	 print *,' d19=',d19,' d20=',d20, ihdr(36)
      IF( ihdr(36) .NE. 0 ) THEN
          ...
          d19 = d19 * dtemp
          d20 = d20 * dtemp
!	print *,' d19=',d19,' d20=',d20,' dtemp=',dtemp
      ENDIF
      lhdr(19) = NINT(d19)
      lhdr(20) = NINT(d20)
!****
!****   Do the receiver coordinates
!****
      ...
      lhdr(21) = NINT(d21)
      lhdr(22) = NINT(d22)
!	 print *,' lhdr=',lhdr(19),lhdr(20),lhdr(21),lhdr(22)
!****
!****
      RETURN
      END
